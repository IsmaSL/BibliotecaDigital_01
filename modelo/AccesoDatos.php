 ...
 *************************************************************/
 ...
 private $oConexion=null; 
		...
		$bRet = false;
			try{
				$this->oConexion = new PDO("pgsql:dbname=bibliodb; host=localhost; user=usubiblio; password=usubiblio1"); 
				//$this->oConexion = new PDO("mysql:host=localhost;dbname=bibliodb","usubiblio","usubiblio1",  array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'UTF8'")); 
				$bRet = true;
			}catch(Exception $e){
				throw $e;
			}
